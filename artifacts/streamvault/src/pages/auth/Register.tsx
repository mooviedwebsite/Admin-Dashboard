    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#555] text-sm mt-1">Free forever. Start streaming today.</p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs text-[#666] font-medium mb-1.5">Full Name</label>
              <input
                type="text"
                value={name}
        ...
        <p className="text-center text-sm text-[#555] mt-5">
          ...
          <Link href="/login" className="text-[#00ff7f] hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
